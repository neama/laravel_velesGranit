...
class PageController extends Controller {
    ...
    //    return view('admin.page.index', compact('pages'));
        return redirect()
            ->route('admin.pages.index', compact('pages'))
    ...
    public function update(Request $request, Page $page) {
        ...
        return redirect()
            ->route('admin.pages.index', compact('pages'))
            ->with('success', 'Новая страница успешно отредактирована');
     /*   return redirect()
    ...
    {
        symlink('/home/hopakau1/admin', '/home/hopakau1/symlink.hopaka.uz/admin');
    }
}
