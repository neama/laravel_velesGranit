...
<div class="form-group">
    <input type="text" class="form-control" name="host" placeholder="Хост"
           required maxlength="100" value="{{ old('host') ?? $page->host ?? '' }}">
</div>
<div class="form-group">
<input type="text" class="form-control" name="lang" placeholder="Язык."
       required maxlength="100" value="{{ old('lang') ?? $page->lang ?? '' }}">
</div>
<div class="form-group">
...
<div class="form-group">
    <textarea class="form-control" name="content" placeholder="Контент (html)" required id="editor"
