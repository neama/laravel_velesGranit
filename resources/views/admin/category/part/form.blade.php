...
<div class="form-group">
    <input type="text" class="form-control" name="host" placeholder="Привязка к хосту"
           required maxlength="100" value="{{ old('slug') ?? $category->host ?? '' }}">
</div>
<div class="form-group">
    <input type="text" class="form-control" name="lang" placeholder="Язык"
           required maxlength="100" value="{{ old('slug') ?? $category->lang ?? '' }}">
</div>
<div class="form-group">
